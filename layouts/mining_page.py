...
def get_layout(reader):
    ...
    return html.Div([dbc.Container(fluid=True, style={'backgroundColor': background_color, 'padding': '15px', 'justifyContent': 'center', 'fontFamily': 'sans-serif',  'color': '#FFFFFF', 'maxWidth': '960px'},
                       ...
                       dash_table.DataTable(id='table-2',
                               ...
                               # html.H1("Payout and rsBTC Selection"),
    
                                # html.Div([
                                #     html.H2("MINT POOL NFT FOR PAYOUT AND TOKEN PAYOUT"),
                                #     html.Div([
                                #         html.Label('Enter minimum payout:'),
                                #         dcc.Input(id='min-payout-input', type='number', value=None),
                                #     ], style={'margin-bottom': '20px'}),
                                    
                                #     # create_token_dropdown('rsbtc-dropdown', 'Select rsBTC', list(range(101)), 0),
                                #     html.Div([
                                #         html.Label('Enter % of rsBTC'),
                                #         dcc.Input(id='rsbtc-input', type='number', value=None),
                                #     ], style={'margin-bottom': '20px'}),
                                    
                                #     html.Button('Submit', id='mint-nft-button', n_clicks=0),
                                # ], style={
